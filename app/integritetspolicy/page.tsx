  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container py-12 max-w-3xl">
        <h1 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-8">Integritetspolicy</h1>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-6 text-foreground/90">
          ...
          <p>Om du har frågor om hur vi hanterar dina personuppgifter är du välkommen att kontakta oss.</p>

          <p className="text-sm text-muted-foreground mt-12">Senast uppdaterad: Juli 2026</p>
        </div>
      </main>
      <Footer />
    </div>
